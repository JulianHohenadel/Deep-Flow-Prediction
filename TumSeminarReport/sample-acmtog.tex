...
% Table
\begin{table}[h]
\caption{Norm comparision wrt. accuracy, L2 default}
\label{tab:one}
\begin{center}
...
\end{center}
\bigskip\centering
\footnotesize The results are averaged over 4 runs with different seeds for all norms.
\end{table}%
